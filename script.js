...
const createNickname = function () {
    ...
    "WydobywaćKobalt", "FilterPowietrza", "SatelitaGeostacjonarny", "AdaptacjaFilmowa", "CenaPopcornu", "EpokaKamienia", "TwierdzenieCosinusów", "KrólestwoSaksonii", "KacprowyWierch", "PiecŁukowy", "OgniwoGalwaniczne", "RozmnażaniePłciowe", "DyskAkrecyjny", "FunkcjaPochodna", "TrudneChwile"];
